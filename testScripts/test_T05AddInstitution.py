...
class Test_AddInstitution(BaseTest):
    ...
    def test_login(self, setup):
        ...
        self.logger.info("******** Click the Add Institutions Button********")
        self.nwc.btnAddInstitution()
        self.logger.info("********Switch to the Add Institution Modal********")
        self.nwccu.switch_to.window(parentwindowid)
        self.logger.info("********Enter the College Name********")
        self.nwc.txtCollegeName(self.cname)
        self.logger.info("********Enter the College Website********")
        self.nwc.txtWebsite(self.url)
        self.logger.info("********Click the Create Button********")
        self.nwc.btnCreate()
        self.nwc.btnDeleteInstitution()
        self.nwc.deleteInstitution()
